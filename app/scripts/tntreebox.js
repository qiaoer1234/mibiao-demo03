var data = [{id: 'o_4', name: '不限', no_box: true,},{id: 'o_1', name: '一级单选1', no_box: true,}, {id: 'o_2', name: '一级单选2', no_box: true,}, {
    id: 'o_3',
    name: '一级单选3',
    no_box: true,
}, {id: 'o_1_1', name: '二级多选1-1', parent_id: 'o_1', no_box: true,}, {
    id: 'o_1_2',
    name: '二级多选1-2',
    parent_id: 'o_1',
    no_box: true,
}, {id: 'o_1_3', name: '二级多选1-3', parent_id: 'o_1', no_box: true,}, {
    id: 'o_1_1_1',
    name: '三级1',
    parent_id: 'o_1_1'
}, {id: 'o_1_1_2', name: '三级2', parent_id: 'o_1_1'}, {id: 'o_1_1_3', name: '三级3', parent_id: 'o_1_1'}, {
    id: 'o_1_1_4',
    name: '三级4',
    parent_id: 'o_1_1'
}, {id: 'o_1_2_1', name: '三级5', parent_id: 'o_1_2'}, {id: 'o_1_2_2', name: '三级6', parent_id: 'o_1_2'}, {
    id: 'o_1_3_1',
    name: '三级7',
    parent_id: 'o_1_3'
}, {id: 'o_1_3_2', name: '三级8', parent_id: 'o_1_3'}, {id: 'o_1_3_3', name: '三级9', parent_id: 'o_1_3'}, {
    id: 'o_1_3_4',
    name: '三级10',
    parent_id: 'o_1_3'
}, {id: 'o_1_3_5', name: '三级11', parent_id: 'o_1_3'}, {id: 'o_1_3_6', name: '三级12', parent_id: 'o_1_3'}];
var _tnTreebox = function () {
};
var _tnTreebox_id = 0;
_tnTreebox.prototype = {
    data: null, dom_id: null, name: null, old_selected: null, width: 0, init: function (dom_id, name, data, selected) {
        this.dom_id = dom_id;
        this.data = data;
        this.name = name;
        ...
        for (var parent_id in _data) {
            ...
            for (var j in list) {
                ...
                var box = '<input' + checked + ' type=\'radio\' id=\'' + id + '\' name=\'' + this.name + '\' value=\'' + item.id + '\' />';
                try {
                    if (item.no_box) {
                        box = '';
                    }
        ...
        $('#' + this.dom_id + ' :radio').on('change', function () {
            that.showChecked();
        });
        that.showChecked();
